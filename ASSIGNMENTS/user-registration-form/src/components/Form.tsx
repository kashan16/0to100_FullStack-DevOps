    ...
    <div className="max-w-md mx-auto bg-white shadow-md rounded-lg p-6 mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={!validate()}
          className={`w-full ${!validate() ? 'bg-gray-400' : 'bg-indigo-600'} text-white py-2 px-4 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2`}>
          Register
        </button>
      </form>
    </div>
